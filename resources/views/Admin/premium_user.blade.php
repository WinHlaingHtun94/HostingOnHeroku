...
<div class="col-md-8">
    ...
    <form action="{{ route('upgrate_to_premium_user') }}" method="POST" enctype="multipart/form-data">
        ...
        @endif
        @csrf
        <legend style="color:violet; font-size:larger;" ><strong>UPGRADE TO PREMIUM USER</strong> </legend>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Type '1' to confirm premium user or not type '0'" name="premium_user">
        </div>
