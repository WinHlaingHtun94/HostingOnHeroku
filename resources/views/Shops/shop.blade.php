...
<head>
    ...
    <body>
        ...
        <!-- Start of Online food shop page -->
            <div class="container">
                    ...
                    <header>
                        <div class="row">
                            ...
                            <h1>
                                ...
                                <a href="{{ route('admin_profile') }}" class="btn btn-ghost">Admin </a> 
                                <a href="{{ route('look_meal') }}" class="btn btn-full">I’m hungry </a>
                                <br> <br> 
                                @if(Session::has('admin_error'))
                                    <div style="color: orange; "><strong><em>{{ Session::get('admin_error') }}</em></strong></div>
                                @endif
                        </div> 
                        </div>  
                    </header>
                    ...
                    <section class="section-meals ">
                        <ul class="meal-showcase clear-fix">
                            ...
                            <figure class="meal-photo">
                                <a href="{{ route('look_meal') }}"><img src="recource/img/1.jpg" alt="Korean bibimbap with egg and vegetables"></a>
                                </figure>
                            </li>
                            <li>
                            <figure class="meal-photo">
                                <a href="{{ route('look_meal') }}"><img src="recource/img/2.jpg" alt="Simple italian pizza with cherry tomatoes"></a>
                                </figure>
                            </li>
                            <li>
                            <figure class="meal-photo">
                                <a href="{{ route('look_meal') }}"><img src="recource/img/3.jpg" alt="Chicken breast steak with vegetables"></a>
                                </figure>
                            </li>
                            <li>
                            <figure class="meal-photo">
                                <a href="{{ route('look_meal') }}"><img src="recource/img/4.jpg" alt="Korean bibimbap with egg and vegetables"></a>
                                </figure>
                            </li>
                        </ul>
                            <ul class="meal-showcase clear-fix">
                                ...
                                <li>
                                <figure class="meal-photo">
                                    <a href="{{ route('look_meal') }}"><img src="recource/img/5.jpg" alt="Paleo beef steak with vegetables"></a>
                                    </figure>
                                </li>
                                <li>
                                <figure class="meal-photo">
                                    <a href="{{ route('look_meal') }}"><img src="recource/img/6.jpg" alt="Healthy baguette with egg and vegetables"></a>
                                    </figure>
                                </li>
                                <li>
                                <figure class="meal-photo">
                                    <a href="{{ route('look_meal') }}"><img src="recource/img/7.jpg" alt="Burger with cheddar and bacon"></a>
                                    </figure>
                                </li>
                                <li>
                                <figure class="meal-photo">
                                    <a href="{{ route('look_meal') }}"><img src="recource/img/8.jpg" alt="Granola with cherries and strawberries"></a>
                                    </figure>
                                </li>
                            </ul>
                    ...
                    <section class="section-step ">
                        ...
                        <div class="row">
                            ...
                            <div class="col span_1_of_2 step-box">
                                ...
                                <div>
                                    <a href="https://www.apple.com/ios/app-store/" class="btn-app"><img src="recource/img/download-app.svg" alt="App Store"></a>
                                
                                    <a href="https://play.google.com/store/apps?hl=en_us" class="btn-app"><img src="recource/img/download-app-android.png" alt="Play Store"></a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="section-cities">
                        ...
                        <div class="row">
                            <div class="col span_1_of_4 box">
                                ...
                                <div class="city-feature">
                                    <i class="fab fa-twitter icon-small"><a href="https://twitter.com/">@omnifood_lx</a></i>
                                </div>
                            </div>
                            <div class="col span_1_of_4 box">
                                ...
                                <div class="city-feature">
                                    <i class="fab fa-twitter icon-small"><a href="https://twitter.com/">@omnifood_sf</a></i>
                                </div>
                            </div>
                            <div class="col span_1_of_4 box">
                                ...
                                <div class="city-feature">
                                    <i class="fab fa-twitter icon-small"><a href="https://twitter.com/">@omnifood_berlin</a></i>
                                </div>
                            </div>
                            <div class="col span_1_of_4 box">
                                ...
                                <div class="city-feature">
                                    <i class="fab fa-twitter icon-small"><a href="https://twitter.com/">@omnifood_london</a></i>  
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="row">
                            <div class="col span-of-2">
                                <ul class="footer-nav">
                                    ...
                                    <li><a href="https://play.google.com/store/apps?hl=en_us">Android App</a></li>
                                </ul>
                            </div>
                            <div class="col span-of-2">
